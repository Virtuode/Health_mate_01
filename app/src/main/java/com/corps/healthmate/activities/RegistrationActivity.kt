...
import com.corps.healthmate.fragment.VerificationBottomSheetDialog
...
class RegistrationActivity : AppCompatActivity() {
                            ...
                            user?.sendEmailVerification()
                                ?.addOnCompleteListener { verificationTask ->
                                    ...
                                    if (verificationTask.isSuccessful) {
                                        ...
                                        handleRegistrationError(verificationTask.exception!!)
                                    }
                                }
                        } else {
                            hideLoading()
                            handleRegistrationError(dbTask.exception!!)
                        }
                    }
                } else {
                    hideLoading()
    ...
    private fun showVerificationBottomSheet() {
        val bottomSheet = VerificationBottomSheetDialog()
        bottomSheet.isCancelable = false
        bottomSheet.setVerificationListener(object : VerificationBottomSheetDialog.VerificationListener {
            override fun onVerificationDone() {
        ...
        bottomSheet.show(supportFragmentManager, VerificationBottomSheetDialog.TAG)
